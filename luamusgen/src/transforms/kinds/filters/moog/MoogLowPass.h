...
#ifndef LUAMUSGEN_MOOGLOWPASS_H
#define LUAMUSGEN_MOOGLOWPASS_H
...
class MoogLowPass : public Transform {
public:
  ...
  struct FunctorMono {
    static void call(const T1& frequency, const T2& resonance, const T3& wetDry, const T4& inner_multiplier,
      ...
      moog::LowPassMono<Saturation> filter(sample_rate);
  ...
  struct FunctorStereo {
    static void call(const T1& frequency, const T2& resonance, const T3& wetDry, const T4& inner_multiplier,
      ...
      moog::LowPassStereo<Saturation> filter(sample_rate);
